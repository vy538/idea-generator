...
export const ideas: Record<Category, Idea[]> = {
  adjective: [{ category: 'adjective', text: { en: 'Mysterious', zh: '神秘的'}, image:"/assets/images/ideas/adj.png"},
  ...
  verb: [{ category: 'verb', text: { en: 'Explore', zh: '探索'}, image:"/assets/images/ideas/verb.png"},
  { category: 'verb', text: { en: 'Conquer', zh: '征服'}, image:"/assets/images/ideas/verb.png"},
